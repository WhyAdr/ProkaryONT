#!/usr/bin/env bash
# ==============================================================================
# 04_polish_orient.sh — Dorado polishing & Dnaapler reorientation
# ==============================================================================
# Usage:
#   bash 04_polish_orient.sh --assembly consensus.fasta --pod5-dir /data/pod5/
#
# Optional flags:
...
require_file "${assembly}" "03_autocycler_assemble.sh"
...
if [[ -s "${polished_assembly}" ]]; then
    log_step "Step 10: Dorado polishing — SKIPPED (polished_assembly.fasta exists)"
else
    log_step "Step 10: Dorado polishing (model=${dorado_model}, min-qscore=${dorado_min_qscore})"

    log_info "10a. Re-basecalling with move tables..."
    ...
    log_info "10b. Aligning to draft assembly..."
...
# ==============================================================================
# STEP 11 — Dnaapler Reorientation
# ==============================================================================

log_step "Step 11: Dnaapler reorientation"

log_info "11a. Reorienting contigs..."
...
_dnaapler_log=""
if [[ -d "dnaapler_out" ]]; then
    _dnaapler_log=$(find dnaapler_out/ -maxdepth 1 -name "*.log" 2>/dev/null | head -1 || true)
fi
